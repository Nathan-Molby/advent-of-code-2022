...
def get_solution_paths_dict_for_years() -> dict[int, dict[int, list[str]]]:
    ...
    """
    solution_paths_dict: dict[int, list[str]] = {}

    # If you have a deep structure then you can adjust the year dir as well:
    # year_dir = year_dir / "src/main/kotlin/com/example/aoc"
    for day_dir in get_paths_matching_regex(Path(os.path.join(AOC_DIR, "src")), DAY_PATTERN):
        ...
        solution_paths_dict[day] = [str(s) for s in solutions]
    return {2022: solution_paths_dict}
